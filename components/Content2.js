export const Content2 = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w bg-[#EFF6FA] dark:bg-[#0C1732] text-[#0C1732]  dark:text-[#00FF00]xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20  ">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight  sm:text-3xl md:mx-auto">
          ...
          Tomorrow, Today:
          <span className="inline-block text-[#122B68] dark:text-gray-300 sm:text-4xl md:text-auto sm:leading-none lg:text-3xl">
            {' '}
            Where AI Meets Infinite Possibilities.
            </span>
        </h2>
        <p className="text-base text-[#122B68] dark:text-gray-400 sm:text-4xl md:text-auto sm:leading-none lg:text-2xl">
      ...
      <div className="grid max-w-screen-lg gap-8 lg:grid-cols-2 sm:mx-auto">
        ...
        <div className="grid grid-cols-2 gap-5">
          <img
            ...
            src="/being created by artificial intelligence expressin (1).jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
            alt=""
          />
           
          <img
            className="object-cover w-full h-48 rounded shadow-lg"
            src="A cute tiny mouse holding a piece of luxury cheese (1).jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
            alt=""
          />
           
          <img
            className="object-cover w-full h-48 rounded shadow-lg"
            src="/A robot chatting with a human.jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"
            alt=""
          />
